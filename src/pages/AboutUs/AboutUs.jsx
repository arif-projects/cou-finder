        ...
        <Row className="justify-content-center text-center mb-4">
          <Col md={8}>
            ...
            <p className="lead text-muted">
              Making it easy for students to report, find, and reclaim lost
              items on campus.
            </p>
          </Col>
        </Row>
        ...
        <Row className="mb-5 align-items-center">
          ...
          <Col md={6} className="mt-4 mt-md-0">
            ...
            <p style={{ fontSize: "1.15rem" }}>
              ...
              process of tracking and reclaiming lost items across the campus.
              We aim to create a tech-friendly environment that connects finders
              and seekers and encourages responsibility and collaboration.
            </p>
          </Col>
        </Row>
          ...
          <Col md={10}>
            ...
            >
              ...
              <p className="text-muted text-center mb-4">
                Share your thoughts or ideas with us — we’d love to hear from
                you!
              </p>
